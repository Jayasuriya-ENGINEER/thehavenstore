      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <img src={LOGO_SVG_WHITE} alt="The Haven" />
            <p>
          ...
          <div className="footer-contact">
            ...
            <ul>
              <li>
                <i className="fas fa-phone-alt"></i> +91 XXXXX XXXXX
              </li>
              <li>
                <i className="fas fa-envelope"></i> hello@thehaven.com
              </li>
              <li>
                <i className="fas fa-map-marker-alt"></i> Your Business Address
              </li>
            </ul>
          </div>
        </div>
